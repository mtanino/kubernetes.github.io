---
title: Change the status of a PersistentVolume from Released to Available
---
...
## Why change status of a PersistentVolume

A `PersistentVolumes` will be in one of the following phases:
